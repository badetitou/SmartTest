...
In this class there is a method in SmTClassP2ReferencesInPackage that references the class SmTClassP1FirstLevelSendersOutsideWithRefInClass  located in the package SmTDataOutsideP1.